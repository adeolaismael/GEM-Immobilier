...
import { getArticlesRecents } from "@/lib/articles";
...
import { HomeLatestArticles } from "@/components/conseils/HomeLatestArticles";
import { HomeContactForm } from "@/components/home/HomeContactForm";
import { AgenceMapbox } from "@/components/AgenceMapbox";
import { getAgencyContact } from "@/lib/agence-contact";

export const metadata: Metadata = {
  title: { absolute: SEO_PAGES.accueil.title },
  description: SEO_PAGES.accueil.description,
};

export default async function Home() {
  const [biens, articles, c, agency] = await Promise.all([
    getBiensLatest(6),
    getArticlesRecents(3),
