...
import { BienPhotoFiligranes } from "./BienPhotoFiligranes";
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
        ...
        >
          ...
          >
            ...
            <BienPhotoFiligranes statut={bien.statut} showStatutFiligrane={false} />
                ...
                {photos.map((p, idx) => (
                  ...
                  >
                    <Image
                      ...
                      sizes="88px"
                    />
                    <BienPhotoFiligranes showStatutFiligrane={false} />
                  </button>
                ))}
              </div>
        ...
        >
          ...
          <Link
            ...
            onClick={() => void trackEvent("clic_contact", bien.id)}
